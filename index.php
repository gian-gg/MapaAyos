...
<body>
    ...
    <header>
        ...
        <div class="btn-group d-none d-md-flex">
            <?php
                if (!isAuthenticated()) {
                echo '<a class="signin-btn" href="./views/SignIn.php">Sign In</a>';
                echo '<a class="signup-btn" href="./views/SignUp.php">Sign Up</a>';
                } else {
    ...
    <main>
        ...
        <section class="hero">
            <div class="hero-content">
                ...
                <div class="cta-btn">
                    <a class="btn1" href="./views/SignUp.php">Mag-Report Na</a>
                    <a class="btn2" href="#how_it_works">How it Works</a>
                </div>
            </div>
        </section>
        ...
        <section class="partners_logo">
            <img src="./assets/img/usc.png" alt="USC Logo">
