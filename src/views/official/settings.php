...
redirectIfNotAllowed($role, "official");
...
if (isset($_POST['upload_image'])) {
    if (isset($_FILES['profile_image']) && $_FILES['profile_image']['error'] === UPLOAD_ERR_OK) {
        ...
        if (in_array($fileExtension, $allowedfileExtensions)) {
            $newFileName = 'official_' . $userID . '_' . time() . '.' . $fileExtension;
...
$additionalCss = ['/MapaAyos/public/css/settings.css'];
$pageTitle = 'MapaAyos - Official Settings';
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>MapaAyos - Officials Settings</title>
