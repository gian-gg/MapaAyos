    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="mobileSidebar" aria-labelledby="mobileSidebarLabel">
        ...
        <div class="offcanvas-body">
            <nav class="nav flex-column">
                <a class="nav-link" href="/MapaAyos/index.php#how_it_works" data-bs-dismiss="offcanvas">How it Works</a>
                <a class="nav-link" href="/MapaAyos/index.php#features" data-bs-dismiss="offcanvas">Features</a>
                <a class="nav-link" href="/MapaAyos/index.php#contact" data-bs-dismiss="offcanvas">Contact</a>
            </nav>
            <div class="mt-3">
                <?php
                if (!isAuthenticated()) {
