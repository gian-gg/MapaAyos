...
<head>
    ...
    <link rel="stylesheet" href="/MapaAyos/public/css/Statistics.css">
...
<body>
    <div class="dashboard">
        <aside class="sidebar">
            ...
            <nav>
                <div>
                    ...
                    <a href="/MapaAyos/user/Statistics" class="nav-item<?php if ($_SERVER['REQUEST_URI'] === '/MapaAyos/user/Statistics') echo ' active'; ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                        ...
                        <?php if ($_SERVER['REQUEST_URI'] === '/MapaAyos/user/Statistics') : ?>
                            <i class="bi bi-chevron-right"></i>
                        <?php endif; ?>
                    </a>
        ...
        <main class="main-content">
            <div class="header">
                <div class="Up-butns">
                    <button class="nav-btn"><i class="bi bi-layout-sidebar"></i></button>
                    <div class="user-stuff">
                        <button class="notif-btn"><i class="bi bi-bell"></i></button>
                        <button class="mode-btn" id="themeToggleBtn">
                            <i class="bi bi-brightness-high" id="themeIcon"></i>
                        </button>
                        <img src="../../assets/Images/placeholder.jpg" alt="" class="PFP">
                    </div>
                </div>
            ...
            <div class="Stat-header">
                <h1>Ikaw sa MapaAyos!</h1>
            </div>
            <div class="stat-area">
                <div class="item item-1">
                    <div class="item-title">Total Reports</div>
                    <div class="item-value">
                        000
                    </div>
                </div>
                <div class="item item-2">
                    <div class="item-title">Received Reports</div>
                    <div class="item-value">
                        000
                    </div>
                </div>
                <div class="item item-3">
                    <div class="item-title">Verification Count</div>
                    <div class="item-value">
                        000
                    </div>
                </div>
                <div class="item item-4">
                    <div class="item-title">Active Reports Nearby</div>
                    <div class="item-value">
                        000
                    </div>
                </div>
            </div>
            <div class="Stat-header2">
                <h1>Ibang mga Barangay sa MapaAyos!</h1>
            </div>
            <div class="stat-area2">
                <div class="item item-5">
                    <div class="item-title">Barangay 1</div>
                    <div class="item-value">
                        000
                    </div>
                </div>
                <div class="item item-6">
                    <div class="item-title">Barangay 2</div>
                    <div class="item-value">
                        000
                    </div>
                </div>
                <div class="item item-7">
                    <div class="item-title">Barangay 3</div>
                    <div class="item-value">
                        000
                    </div>
                </div>
            </div>
            <div class="stat-area3">
                <div class="item item-8">
                    <div class="item-title">Top Barangays</div>
                    <div class="item-value">
                        000
                    </div>
                </div>
                <div class="item item-9">
                    <div class="item-title">App Activity</div>
                    <div class="item-value">
                        000
                    </div>
                </div>
    ...
    <script src="/MapaAyos/public/js/theme.js"></script>
</body>
