        ...
        <aside class="sidebar">
            ...
            <nav>
                <div>
                    ...
                    <a href="/MapaAyos/user/Statistics" class="nav-item">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
        ...
        <main class="main-content">
            ...
            <div class="cards-grid">
                ...
                <div class="card card-4">
                    <div class="card-title">Placeholder 1</div>
                    <div class="card-value">
                        000
                    </div>
                </div>
                <div class="card card-5">
                    <div class="card-title">Other Reports</div>
                    <div class="card-value">
                        000
                    </div>
                </div>
                <div class="card card-6">
                    <div class="card-title">Placeholder 2</div>
                    <div class="card-value">
                        000
                    </div>
                </div>
