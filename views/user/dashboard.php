...
<head>
    ...
    <link rel="stylesheet" href="/MapaAyos/assets/css/sidebar.css">
...
<body>
    <div class="dashboard">
        <aside class="sidebar">
            <a href="/MapaAyos/index.php">
                <div class="branding">
                    <img src="/MapaAyos/assets/img/brand-logo.png" alt="MapaAyos" width="34" height="34" style="border-radius: 5px;">
    ...
    <script src="/MapaAyos/assets/js/sidebar.js"></script>
</body>
</html>
